...
import { injectDocumentId, injectDocuments, injectKernelHost } from '@embedpdf-x/angular/runtime';
import { EpdfPageChrome, EpdfPageTemplate, EpdfStage } from '@embedpdf-x/angular/stage';
import { EpdfRenderLayer } from '@embedpdf-x/angular/render';
