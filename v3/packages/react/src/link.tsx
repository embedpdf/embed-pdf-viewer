/**
 * The React view of @embedpdf-x/plugin-link — the navigation plane's paint.
 *
...
export * from '@embedpdf-x/plugin-link';
import * as React from 'react';
import { useEffect } from 'react';
import { LinkToken, type LinkNavItem } from '@embedpdf-x/plugin-link';
import { sanitizeExternalUri } from '@embedpdf-x/web';
