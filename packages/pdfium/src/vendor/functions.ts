...
export const functions = {
  ...
  EPDF_SanitizeFonts: [['number'] as const, 'number'] as const,
  ...
  EPDFPage_DetectTextBlocks: [['number', 'number'] as const, 'boolean'] as const,
  EPDFPage_EnableLayoutDebug: [['number', 'boolean'] as const, 'boolean'] as const,
  ...
  EPDFPage_GetColumnBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetColumnCount: [['number'] as const, 'number'] as const,
  EPDFPage_GetLineBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetLineCount: [['number'] as const, 'number'] as const,
  EPDFPage_GetTableBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetTableCellCount: [['number', 'number'] as const, 'number'] as const,
  EPDFPage_GetTableCount: [['number'] as const, 'number'] as const,
  EPDFPage_GetTextBlockBitmapSize: [
    ['number', 'number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
  EPDFPage_GetTextBlockCount: [['number'] as const, 'number'] as const,
  EPDFPage_GetTextBlockInkBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetTextBlockLayoutBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetTextBlockText: [['number', 'number', 'number', 'number'] as const, 'number'] as const,
  EPDFPage_GetTextBlockType: [['number', 'number'] as const, 'number'] as const,
  EPDFPage_GetWordBounds: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_GetWordCount: [['number'] as const, 'number'] as const,
  EPDFPage_InvalidateTextBlocks: [['number'] as const, null] as const,
  ...
  EPDFPage_RenderBackgroundExcludingTextBlocks: [
    ['number', 'number', 'number', 'number', 'number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
  EPDFPage_RenderLayoutDebugOverlay: [
    ['number', 'number', 'number', 'number', 'number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
  EPDFPage_RenderTextBlockBitmap: [
    ['number', 'number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
