...
export const functions = {
  ...
  FPDFPage_SetArtBox: [["number","number","number","number","number"] as const, 'boolean'] as const,
  FPDFPage_SetBleedBox: [["number","number","number","number","number"] as const, 'boolean'] as const,
  FPDFPage_SetCropBox: [["number","number","number","number","number"] as const, 'boolean'] as const,
  FPDFPage_SetMediaBox: [["number","number","number","number","number"] as const, 'boolean'] as const,
  FPDFPage_SetTrimBox: [["number","number","number","number","number"] as const, 'boolean'] as const,
  FPDFPage_New: [["number","number","number","number"] as const, 'number'] as const,
  FPDF_SaveAsCopy: [["number","number","number"] as const, 'number'] as const
}
