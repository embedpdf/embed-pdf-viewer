...
- [#822](https://github.com/embedpdf/embed-pdf-viewer/pull/822) by [@bobsingor](https://github.com/bobsingor) – Fix text redaction when multiple regions intersect the same text object. Later
