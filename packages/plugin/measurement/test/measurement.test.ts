...
import { createMeasurementCapability } from '../src/controller';
import { initialMeasurementState, measurementReducer } from '../src/model';

const PAGE = toPageRef(1);

/** A kernel-shaped context over one page whose scale the test controls (no engine measure service). */
