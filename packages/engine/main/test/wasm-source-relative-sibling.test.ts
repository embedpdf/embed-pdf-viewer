...
// `/_next/static/media/pdfium.<hash>.wasm`. A blob: worker cannot resolve
...
vi.mock('@embedpdf/engine-runtime-wasm32/wasm-url', () => ({
  default: '/_next/static/media/pdfium.abc123.wasm',
}));
...
describe('resolveInlineWasmSource with a bundler-relative sibling URL', () => {
  test('absolutizes against the page location, keeping the CDN fallback', async () => {
    ...
    expect(resolved.wasmUrl).toBe('https://app.test/_next/static/media/pdfium.abc123.wasm');
