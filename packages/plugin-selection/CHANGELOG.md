...
- [#685](https://github.com/embedpdf/embed-pdf-viewer/pull/685) by [@simonmysun](https://github.com/simonmysun) – Add `setSelection(range, documentId?)` to the selection capability and document scope for programmatically applying or restoring a text selection.
