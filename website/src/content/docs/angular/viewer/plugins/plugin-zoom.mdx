...
```ts
import { EmbedPdfViewerComponent, ZoomMode } from '@embedpdf/angular-pdf-viewer';
...
import { EmbedPdfViewerComponent, ZoomMode, type PluginRegistry, type ZoomPlugin } from '@embedpdf/angular-pdf-viewer';
