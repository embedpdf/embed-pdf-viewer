...
```ts
import { EmbedPdfViewerComponent, SpreadMode } from '@embedpdf/angular-pdf-viewer';
...
import { EmbedPdfViewerComponent, SpreadMode, type PluginRegistry, type SpreadPlugin } from '@embedpdf/angular-pdf-viewer';
...
```ts
import { EmbedPdfViewerComponent, type PluginRegistry } from '@embedpdf/angular-pdf-viewer';
