...
import { CommandsExample } from '../code-examples/commands-example'

<CodeExample 
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/commands-example.svelte",
    "../../examples/svelte-tailwind/src/examples/commands-example-content.svelte"
  ]}
>
  <CommandsExample />
</CodeExample>
