...
import { ExportExample } from '../../code-examples/headless/export-example';

<CodeExample 
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/headless/export-example.svelte",
    "../../examples/svelte-tailwind/src/examples/headless/export-example-content.svelte"
  ]}
>
  <ExportExample />
</CodeExample>
