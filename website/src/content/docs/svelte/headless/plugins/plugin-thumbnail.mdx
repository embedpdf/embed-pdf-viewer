...
<div class="relative h-full overflow-hidden">
  <ThumbnailsPane {documentId}>
    {#snippet children(meta: ThumbMeta)}
      ...
      >
        <div
          class={scroll.state.currentPage === meta.pageIndex + 1 ? 'ring-2 ring-blue-500' : ''}
...
<CodeExample 
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/headless/thumbnail-example.svelte",
    "../../examples/svelte-tailwind/src/examples/headless/thumbnail-example-content.svelte"
  ]}
>
  <ThumbnailExample />
</CodeExample>
...
| **`labelHeight`** | `number` | Height reserved for the label below the image. |
