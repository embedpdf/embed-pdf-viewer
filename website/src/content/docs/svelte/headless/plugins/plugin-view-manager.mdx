...
import { ViewManagerExample } from '../../code-examples/headless/view-manager-example'

<CodeExample 
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/headless/view-manager-example.svelte",
    "../../examples/svelte-tailwind/src/examples/headless/view-manager-example-content.svelte",
    "../../examples/svelte-tailwind/src/examples/headless/view-manager-example-tab-bar.svelte"
  ]}
>
  <ViewManagerExample />
</CodeExample>
