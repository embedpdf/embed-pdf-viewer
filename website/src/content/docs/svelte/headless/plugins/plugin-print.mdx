...
import { PrintExample } from '../../code-examples/headless/print-example';

<CodeExample 
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/headless/print-example.svelte",
    "../../examples/svelte-tailwind/src/examples/headless/print-example-content.svelte"
  ]}
>
  <PrintExample />
</CodeExample>
