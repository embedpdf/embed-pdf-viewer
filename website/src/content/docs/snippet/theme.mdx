...
description: "Customize the EmbedPDF Snippet viewer's appearance with light, dark, and system color modes. Override colors for backgrounds, text, accents, borders, and semantic states."
---
