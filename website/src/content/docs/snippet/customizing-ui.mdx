...
description: "Customize toolbar buttons, menus, layout, and appearance of the EmbedPDF Snippet PDF viewer. Add custom commands, icons, and UI schema modifications at runtime."
---
