...
import { DocumentManagerExample } from '../code-examples/document-manager-example'

<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/document-manager-example.vue",
    "../../examples/vue-tailwind/src/examples/document-manager-example-content.vue"
  ]}
>
...
import { PasswordExample } from '../code-examples/password-example'

<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/password-example.vue",
    "../../examples/vue-tailwind/src/examples/password-example-content.vue"
  ]}
>
  <PasswordExample />
</CodeExample>
