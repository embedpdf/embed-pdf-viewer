...
import { ScrollInitialPageExample } from '../code-examples/scroll-initial-page-example';

<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/scroll-example.vue",
    "../../examples/vue-tailwind/src/examples/scroll-example-content.vue"
  ]}
>
  <ScrollExample />
</CodeExample>
...
<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/scroll-initial-page-example.vue",
    "../../examples/vue-tailwind/src/examples/scroll-initial-page-example-content.vue"
  ]}
>
