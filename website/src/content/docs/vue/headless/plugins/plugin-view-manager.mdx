...
<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/headless/view-manager-example.vue",
    "../../examples/vue-tailwind/src/examples/headless/view-manager-example-content.vue",
    "../../examples/vue-tailwind/src/examples/headless/view-manager-example-tab-bar.vue"
  ]}
>
  <ViewManagerExample />
</CodeExample>
