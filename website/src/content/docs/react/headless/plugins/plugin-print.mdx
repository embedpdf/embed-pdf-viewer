...
Use the `usePrint` hook to get access to the plugin's `print` method for the current document. You can call this method from any component, such as a button in your toolbar.
...
export const PrintToolbar = ({ documentId }) => {
...
import { PDFViewer } from '../../code-examples/headless/print-example';

<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/headless/print-example.tsx"
  ]}
>
  <PDFViewer />
</CodeExample>
...
### Hook: `usePrint(documentId)`

This hook connects your component to the print plugin's functions for a specific document.
