...
export const RotateToolbar = ({ documentId }) => {
...
import { PDFViewer } from '../../code-examples/headless/rotate-example'

<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/headless/rotate-example.tsx"
  ]}
>
  <PDFViewer />
</CodeExample>
