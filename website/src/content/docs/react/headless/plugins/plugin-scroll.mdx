...
import { PDFViewer } from '../../code-examples/headless/scroll-example';
import { PDFViewerWithInitialPage } from '../../code-examples/headless/scroll-initial-page-example';

<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/headless/scroll-example.tsx"
  ]}
>
  <PDFViewer />
</CodeExample>
...
<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/headless/scroll-initial-page-example.tsx"
  ]}
>
