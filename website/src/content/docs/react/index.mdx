...
EmbedPDF offers two ways to add PDF viewing to your React application. Choose the approach that fits your project.
...
<Cards num={2}>
  ...
  <Cards.Card
    ...
    description="Build a completely custom viewer using our hooks and unstyled components. Total UI freedom."
