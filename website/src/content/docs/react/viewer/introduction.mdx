...
description: A complete, production-ready PDF viewer component for React.
searchable: true
---
...
If you need complete control over every pixel, a custom toolbar layout, or a unique viewing experience, consider using our [Headless Components](/docs/react/headless/introduction) instead.

## Quick Start

Ready to dive in? [Get started in minutes](/docs/react/viewer/getting-started).
