...
import { PDFViewer } from '../code-examples/i18n-example'

<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/i18n-example.tsx"
  ]}
  githubUrl="https://github.com/embedpdf/embed-pdf-viewer/blob/main/website/src/content/docs/react/code-examples/i18n-example.tsx"
>
  <PDFViewer />
</CodeExample>
