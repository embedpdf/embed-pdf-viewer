...
<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/rotate-example.tsx"
  ]}
  githubUrl="https://github.com/embedpdf/embed-pdf-viewer/blob/main/website/src/content/docs/react/code-examples/rotate-example.tsx"
>
  <PDFViewer />
</CodeExample>
