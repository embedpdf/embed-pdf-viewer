...
<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/redaction-example.tsx"
  ]}
  githubUrl="https://github.com/embedpdf/embed-pdf-viewer/blob/main/website/src/content/docs/react/code-examples/redaction-example.tsx"
>
  <PDFViewer />
</CodeExample>
