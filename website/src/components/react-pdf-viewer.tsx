...
import { ReactIcon } from './framework-icons'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-6 py-2 text-sm font-medium text-blue-800 dark:border-blue-800/30 dark:bg-blue-900/20 dark:text-blue-300">
              <ReactIcon className="h-4 w-4" />
              <span>React PDF Viewer Open Source Library</span>
            </div>
            ...
            <h1 className="md:text-7xl text-4xl font-black leading-tight tracking-tight text-gray-900 dark:text-white sm:text-6xl">
              <span className="relative inline-block">
                ...
                <div className="absolute bottom-1 left-0 right-0 -z-10 h-3 -rotate-1 transform text-blue-400 opacity-50 dark:text-blue-500 md:h-4">
            ...
            <p className="relative mx-auto mt-6 max-w-2xl text-lg text-gray-600 dark:text-gray-400 md:mt-8 md:text-xl">
              The ultimate <strong>React PDF viewer</strong> for your next
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-10 md:gap-4">
              ...
              >
                <Play className="mr-2 h-4 w-4 fill-current text-blue-600 transition-transform group-hover:scale-110 dark:text-blue-400" />
                Live Demo
              </a>
    ...
    <div className="mt-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
            Get a fully featured PDF viewer in your React app with just a few
            lines of code.
          </p>
        </div>

        <CodeShowcase framework="react" />
...
const featurePlugins = [
  ...
  { name: 'i18n', icon: <Settings size={18} />, pkg: 'plugin-i18n' },
]
...
const HeadlessCodeSnippet = () => (
  <div className="overflow-hidden rounded-2xl bg-gray-950 shadow-2xl ring-1 ring-white/10">
    ...
    <div className="flex items-center justify-between border-b border-gray-800 bg-gray-900/50 px-4 py-3">
      ...
      <span className="text-xs text-gray-500">PDFViewer.tsx</span>
    </div>
    {/* Code */}
    <div className="overflow-x-auto p-5 font-mono text-[13px] leading-relaxed text-gray-300">
      <div className="min-w-fit space-y-0.5">
        ...
        <p className="text-gray-500">// Build your own UI with hooks</p>
        <p>
          <span className="text-purple-400">const</span>{' '}
          <span className="text-gray-300">{'{'}</span>{' '}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    , or any hook with your own buttons, sliders, and
                    components.
                  </p>
                </div>
              </div>
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                ...
                <p className="mb-6 max-w-md text-gray-600 dark:text-gray-400">
                  Not an afterthought. Every prop, hook, and event is fully
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                client-only logic gracefully, so you don't have to fight with
                hydration errors.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900 md:col-span-2">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                ...
                <p className="mb-6 max-w-md text-gray-600 dark:text-gray-400">
                  Don't ship a 5MB viewer when you only need to show a simple
                  invoice. Our modular architecture means you import only the
                  parts you need, keeping your initial bundle size tiny.
                </p>
              </div>
              {/* Size visual */}
...
const faqs = [
  {
    question: 'How is this different from react-pdf?',
    answer:
  ...
  {
    question: 'Does it work with Next.js App Router (RSC)?',
    answer:
  ...
  {
    question: 'Can I style it with Tailwind CSS?',
    answer:
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="group rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-blue-200 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-900"
            >
