    ...
    <div className="not-prose border-ep-border my-8 overflow-hidden rounded-[16px] border bg-white shadow-[0_1px_2px_rgba(10,26,77,0.05)]">
      ...
      >
        <button
          ...
          className="border-ep-border text-ep-navy hover:text-ep-blue inline-flex h-[38px] items-center gap-2.5 rounded-[10px] border bg-white px-[15px] font-sans text-[13px] font-bold transition-colors hover:border-[#CFE0FF] hover:bg-[#F4F8FF]"
        >
        ...
        {repoGithubUrl && (
          <a
            ...
            className="text-ep-soft hover:text-ep-navy inline-flex items-center gap-2 rounded-[10px] px-3 py-2.5 font-sans text-[13px] font-bold transition-colors hover:bg-[#EEF3FC]"
          >
        ...
        <div className="overflow-hidden rounded-b-[16px] bg-[#0E1A40]">
          ...
          <div className="overflow-x-auto">
            {activeFile.highlightedCode ? (
              <pre className="ep-code px-[18px] py-4 font-mono text-[13px] leading-[1.8] text-[#C8D3EA]">
