...
import { FlowbiteSvelteLogo, TailwindLogo } from './logos'
import {
  ArrowRight,
  Check,
  Cpu,
...
import { SvelteIcon } from './framework-icons'
...
const AnimatedBackground = () => {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      {/* Orange blob - Svelte Primary */}
      <div className="top-70 animate-blob absolute left-8 h-64 w-64 rounded-full bg-orange-500 opacity-10 mix-blend-multiply blur-3xl filter dark:opacity-20 dark:mix-blend-normal"></div>

      {/* Blue blob - TypeScript/Headless */}
      ...
      {/* Purple blob - Full UI */}
      <div className="animate-blob animation-delay-4000 absolute bottom-24 left-20 h-72 w-72 rounded-full bg-purple-400 opacity-10 mix-blend-multiply blur-3xl filter dark:opacity-20 dark:mix-blend-normal"></div>
...
// Svelte UI Framework data
const frameworks = [
  { name: 'Flowbite Svelte', logo: <FlowbiteSvelteLogo /> },
  { name: 'Tailwind CSS', logo: <TailwindLogo /> },
  // Using SvelteIcon for SvelteKit as they share the brand
  {
    name: 'SvelteKit',
    logo: <SvelteIcon className="h-10 w-10 text-[#FF3E00]" />,
  },
]
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-6 py-2 text-sm font-medium text-orange-800 dark:border-orange-800/30 dark:bg-orange-900/20 dark:text-orange-300">
              <SvelteIcon className="h-4 w-4" />
              <span>Svelte PDF Viewer Open Source Library</span>
            </div>
            ...
            <h1 className="md:text-7xl text-4xl font-black leading-tight tracking-tight text-gray-900 dark:text-white sm:text-6xl">
              <span className="relative inline-block">
                <span className="relative z-10">Svelte PDF Viewer</span>
                <div className="absolute bottom-1 left-0 right-0 -z-10 h-3 -rotate-1 transform text-orange-400 opacity-50 dark:text-orange-500 md:h-4">
            ...
            <p className="relative mx-auto mt-6 max-w-2xl text-lg text-gray-600 dark:text-gray-400 md:mt-8 md:text-xl">
              The ultimate <strong>Svelte PDF viewer</strong> for your next
              project. Choose our pre-built viewer for instant results, or use
              our <strong>headless components</strong> to build a completely
              custom UI.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-10 md:gap-4">
              ...
              >
                <span className="absolute left-0 top-0 h-full w-full bg-gradient-to-r from-orange-600 via-red-500 to-pink-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></span>
              ...
              <a
                href="https://svelte-tailwind.embedpdf.com"
                target="_blank"
                rel="noreferrer"
              ...
              >
                <Play className="mr-2 h-4 w-4 fill-current text-orange-600 transition-transform group-hover:scale-110 dark:text-orange-400" />
                Live Demo
              </a>
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 text-left md:grid-cols-2">
          ...
          <div className="group relative flex h-full flex-col rounded-3xl border border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="mb-6 min-h-[3rem] text-gray-600 dark:text-gray-400">
              Use our powerful components to build a viewer that perfectly
    ...
    <div className="mt-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
            Get a fully featured PDF viewer in your Svelte app with just a few
            lines of code.
          </p>
        </div>

        <CodeShowcase framework="svelte" />

        <div className="mt-8 flex justify-center">
          <Link
            href="/docs/svelte/viewer/getting-started"
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
            ...
            <code className="rounded bg-gray-100 px-1.5 py-0.5 text-base font-medium text-orange-600 dark:bg-gray-800 dark:text-orange-400">
              &lt;PDFViewer /&gt;
            </code>{' '}
            component.
            <br />
...
const HeadlessCodeSnippet = () => (
  <div className="overflow-hidden rounded-2xl bg-gray-950 shadow-2xl ring-1 ring-white/10">
    ...
    <div className="flex items-center justify-between border-b border-gray-800 bg-gray-900/50 px-4 py-3">
      ...
      <span className="text-xs text-gray-500">PDFViewer.svelte</span>
    </div>
    {/* Code */}
    <div className="overflow-x-auto p-5 font-mono text-[13px] leading-relaxed text-gray-300">
      <div className="min-w-fit space-y-0.5">
        ...
        <p>
          ...
          <span className="text-cyan-300">zoomStore</span>{' '}
          <span className="text-gray-300">{'}'}</span>
        </p>
        <p className="pl-4">
          <span className="text-purple-400">from</span>{' '}
        ...
        <p className="text-gray-500">// Use stores for reactive state</p>
        <p>
          <span className="text-purple-400">const</span>{' '}
          <span className="text-gray-300">{'{'}</span>{' '}
          ...
          <span className="text-gray-300">{'}'}</span> ={' '}
          <span className="text-yellow-300">zoomStore</span>(
        ...
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <div className="order-1 min-w-0">
            ...
            <div className="mt-6 flex justify-center lg:justify-start">
              <Link
                href="/docs/svelte/headless/understanding-plugins"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    , or any store with your own buttons, sliders, and
                    components.
                  </p>
                </div>
              </div>
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                ...
                <p className="mb-6 max-w-md text-gray-600 dark:text-gray-400">
                  Not an afterthought. Every prop, store, and event is fully
...
const faqs = [
  {
    question: 'How is this different from svelte-pdf?',
    answer:
  ...
  {
    question: 'Does it work with SvelteKit?',
    answer:
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="group rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-orange-200 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900 dark:hover:border-orange-900"
            >
    ...
    <div className="relative mb-20 mt-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="absolute -left-24 -top-24 h-96 w-96 rounded-full bg-orange-500/20 blur-3xl"></div>
          <div className="absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-red-500/20 blur-3xl"></div>
...
export default function SveltePDFViewerPage() {
  return (
