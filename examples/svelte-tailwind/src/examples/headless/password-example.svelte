<script lang="ts">
  ...
  import PasswordExampleContent from './password-example-content.svelte';
          ...
          <DocumentContent documentId={activeDocumentId}>
            {#snippet children(documentContent)}
              ...
              {:else if documentContent.isError}
                <div class="h-[400px] bg-gray-50 sm:h-[500px] dark:bg-gray-900/50">
                  <PasswordExampleContent documentState={documentContent.documentState} />
                </div>
              {:else if documentContent.isLoaded}
                <PasswordExampleContent
                  documentState={documentContent.documentState}
