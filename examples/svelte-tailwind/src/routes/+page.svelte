...
>
  <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-xl">
    <h1 class="mb-6 text-4xl font-bold text-gray-900">EmbedPDF Svelte + Tailwind</h1>

    <div class="mb-8 space-y-4 text-gray-600">
      <p class="text-lg">
        Welcome to the EmbedPDF example for Svelte and Tailwind CSS. This demonstrates how to
        integrate a powerful PDF viewer into your Svelte applications with a beautiful, modern UI.
      </p>

      <div class="rounded-lg bg-blue-50 p-4">
        <h2 class="mb-2 font-semibold text-blue-900">Features:</h2>
        <ul class="list-inside list-disc space-y-2 text-sm">
          ...
          <li>Modern Svelte 5 architecture</li>
        </ul>
      </div>
    </div>
