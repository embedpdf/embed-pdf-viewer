...
<div>
  <div class="flex w-full items-center gap-3 border-b border-gray-200 bg-blue-500 px-4 py-2">
    <!-- Menu Button -->
    <div class="relative" use:clickOutside={closeMenu}>
      <button
        class="flex h-8 w-8 items-center justify-center text-gray-100 rounded-full transition-colors {isMenuOpen
    ...
    <button
      class="flex h-8 w-8 items-center justify-center rounded-full text-gray-100 transition-colors {isSidebarOpen
        ? 'bg-gray-200 text-gray-900'
        : 'hover:bg-gray-100 hover:text-gray-900'}"
    ...
    <!-- Pan Mode Button -->
    <button
      class="flex h-8 w-8 items-center justify-center text-gray-100 rounded-full transition-colors {pan.isPanning
        ? 'bg-gray-200 text-gray-900'
        : 'hover:bg-gray-100 hover:text-gray-900'}"
    ...
    <!-- Pointer Mode Button -->
    <button
      class="flex h-8 w-8 items-center justify-center text-gray-100 rounded-full transition-colors {interactionManager
    ...
    <div class="flex flex-1 items-center justify-center">
      <!-- Mode Tabs -->
      <button
        class=" px-3 py-1 text-sm font-medium transition-all {mode === 'view'
          ? 'text-white border-b'
          : 'text-gray-300 '}"
      ...
      <button
        class=" px-3 py-1 text-sm font-medium transition-all {mode === 'annotate'
          ? 'text-white border-b'
          : 'text-gray-300 '}"
    ...
    <button
      class="flex h-8 w-8 items-center justify-center text-gray-100 rounded-full transition-colors {isSearchOpen
        ? 'bg-gray-200 text-gray-900'
        : 'hover:bg-gray-100 hover:text-gray-900'}"
