...
1. **[Upload a document](/docs/api-reference/documents/upload)** — one SDK call for
   files you already hold. It prefers a presigned object-store transfer and uses
   the bounded origin proxy only when the deployment permits it.
