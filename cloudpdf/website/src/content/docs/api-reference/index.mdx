...
1. **[Upload a document](/docs/api-reference/documents/upload-direct)** — one call for
   files you already hold. For large or resumable uploads use
   [initialize](/docs/api-reference/documents/init) → `PUT` → [commit](/docs/api-reference/documents/commit).
