...
export interface DocPagesSetScale400Response {
    name: DocPagesSetScale400Response.Name;
    code: DocPagesSetScale400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesSetScale400Response {
    export const Name = {
