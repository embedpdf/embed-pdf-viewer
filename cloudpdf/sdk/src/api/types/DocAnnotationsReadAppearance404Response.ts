...
export interface DocAnnotationsReadAppearance404Response {
    name: DocAnnotationsReadAppearance404Response.Name;
    code: DocAnnotationsReadAppearance404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsReadAppearance404Response {
    export const Name = {
