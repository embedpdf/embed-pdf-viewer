...
export interface DocPagesViewports404Response {
    name: DocPagesViewports404Response.Name;
    code: DocPagesViewports404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesViewports404Response {
    export const Name = {
