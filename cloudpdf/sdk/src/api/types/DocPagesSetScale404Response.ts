...
export interface DocPagesSetScale404Response {
    name: DocPagesSetScale404Response.Name;
    code: DocPagesSetScale404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesSetScale404Response {
    export const Name = {
