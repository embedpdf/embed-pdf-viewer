...
export interface DocAnnotationsReadAppearance400Response {
    name: DocAnnotationsReadAppearance400Response.Name;
    code: DocAnnotationsReadAppearance400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsReadAppearance400Response {
    export const Name = {
