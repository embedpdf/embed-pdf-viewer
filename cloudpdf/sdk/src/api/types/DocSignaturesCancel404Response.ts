...
export interface DocSignaturesCancel404Response {
    name: DocSignaturesCancel404Response.Name;
    code: DocSignaturesCancel404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesCancel404Response {
    export const Name = {
