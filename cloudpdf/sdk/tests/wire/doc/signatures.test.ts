            ...
            signatures: [
                {
                    ...
                    fieldName: "fieldName",
                    widget: { annotObjectNumber: 1, page: null },
                    signed: true,
                    kind: "signature",
                    filter: "filter",
                    subFilter: "subFilter",
    ...
    test("complete (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            signature: {
                ...
                field: { kind: "objectNumber", fieldObjectNumber: 1 },
                fieldName: "fieldName",
                widget: { annotObjectNumber: 1, page: { kind: "objectNumber", pageObjectNumber: 1 } },
                signed: true,
                kind: "signature",
                filter: "filter",
                subFilter: "subFilter",
            ...
            meta: {
                affectedPages: [
                    {
                        page: null,
                        revision: { docSessionId: "docSessionId", page: null, generation: 1 },
                ...
                cacheDelta: {
                    ...
                    layerVersion: 1,
                    working: true,
                    pages: [{ page: null, cache: { contentVersion: 1, annotationVersion: 1 } }],
                },
            },
        };
