...
export const englishTranslations: Locale = {
  ...
  translations: {
    ...
    measurement: {
      ...
      areaRect: 'Area (Rectangle)',
      areaEllipse: 'Area (Ellipse)',
      moreTools: 'More measurement tools',
      drawHint: 'Click to add points, then double-click to finish',
      calibrate: 'Calibrate Scale',
      calibrateTitle: 'Calibrate measurement scale',
      calibrateIntro:
        'Set how on-page distance maps to real-world units. New measurements use this scale.',
      pagePoints: 'Page distance (points)',
      realValue: 'Equals',
      unit: 'Unit',
      preview: 'Preview',
      apply: 'Apply',
    ...
    annotation: {
      ...
      precisionFraction: 'Fraction',
      decimalPlaces: 'Decimal places',
      denominator: 'Denominator (1/n)',
      scaleLabel: 'Scale',
      calibrateAction: 'Calibrate…',
      secondaryUnit: 'Secondary unit',
      showSecondary: 'Show secondary unit',
    },
    insert: {
      image: 'Image',
