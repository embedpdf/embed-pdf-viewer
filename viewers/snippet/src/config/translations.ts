...
export const japaneseTranslations: Locale = {
  ...
  translations: {
    ...
    annotation: {
      ...
      overlayTextPlaceholder: '例: 墨消し済み',
      rotation: '回転',
    },
    redaction: {
      redact: '墨消し',
      ...
      applyAll: 'すべて適用',
      clearAll: 'すべてクリア',
      deleteSelected: '選択した墨消しを削除',
      commitSelected: '選択した墨消しを適用',
      emptyState: '保留中の墨消しはありません',
      panel: {
        title: '墨消し',
        itemCount: '{count}件の保留中の墨消し',
        itemCountPlural: '{count}件の保留中の墨消し',
        clearAll: 'すべてクリア',
        redactAll: 'すべて墨消し',
      },
    },
