...
| `framework/` | ALL framework-specific code (ADAPTERS.md). Nothing framework-flavored exists outside this group — where "framework-flavored" means ADAPTER code (hooks/components for composing viewers); see `viewer/`.                                                                                                                                                                                |
...
`cloudpdf/engine`, `cloudpdf/server`, `cloudpdf/admin`, `cloudpdf/admin-api`
